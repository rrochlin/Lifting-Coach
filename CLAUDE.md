...
Next, in rough order:
- **`notes/Feedback.md` has a `## Backlog` section** for wanted-but-bigger-than-a-fix items (plate calculator, set type in the tracker, the bodyweight wheel). Put new ones there rather than in this file's prose.
